...
<!--ChromBERT includes pre-trained models for promoter regions (2 kb upstream to 4 kb downstream of TSS) and whole-genome regions, covering both the 15-chromatin state system (127 cell types from the ROADMAP database) and the 18-chromatin state system (1699 cell types from the IHEC database). Fine-tuned models for gene expression classification and regression (15-chromatin state system) are also provided. -->
ChromBERT provides pre-trained models for promoter and whole-genome regions based on the 15-chromatin-state system (127 ROADMAP cell types), and will additionally provide pre-trained models based on the 18-chromatin-state system derived from IHEC data (1,699 cell types; to be released publicly upon publication of the corresponding IHEC paper). Fine-tuned models for gene expression classification and regression are also available for the 15-chromatin-state system.
For downstream analysis, ChromBERT offers a DTW-based motif clustering and visualization tool.
